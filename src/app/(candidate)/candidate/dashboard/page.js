    ...
    <div className="min-h-screen flex flex-col bg-[#f0f2f5]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-6">
        ...
        <div className="flex items-center justify-between gap-4 mb-5">
          ...
          {/* Spacer to balance layout (no create button for candidate) */}
            ...
            <div className="flex items-center justify-between mt-5">
              <div className="flex items-center gap-1">
                <button
                  ...
                  disabled={page === 1}
                  className="w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 text-gray-500 disabled:opacity-30 disabled:cursor-not-allowed hover:border-[#6B3FE7] hover:text-[#6B3FE7] hover:bg-purple-50 transition-all"
                >
