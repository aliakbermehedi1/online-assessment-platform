        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <Link href="/employer/tests/create">
              <button className="bg-[#6B3FE7] hover:bg-[#5a33c4] text-white px-5 py-2.5 rounded-lg text-sm font-semibold whitespace-nowrap transition-colors">
                Create Online Test
              </button>
            </Link>
          </div>
          ...
          <div className="flex items-center justify-between mt-6">
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={page === 1}
                className="w-8 h-8 flex items-center justify-center border border-gray-200 rounded-lg text-gray-600 disabled:opacity-40 hover:border-[#6B3FE7] hover:text-[#6B3FE7] transition-colors"
              >
                ‹
              </button>
